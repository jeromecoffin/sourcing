...
def show_dashboard():
    ...
    col1.metric(label="Nombre Total de Fournisseurs", value=kpis["total_suppliers"], delta="-8%")
    col2.metric(label="Nombre Total de Clients", value=kpis["total_clients"], delta="0")
